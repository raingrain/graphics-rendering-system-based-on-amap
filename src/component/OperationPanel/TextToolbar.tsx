...
//             <label className="ControlPanel-LabelAndButton flex flex-row items-center justify-around rounded-2xl m-2 cursor-pointer">
//                 <input
//                     type="radio"
//                     name="editText"
...
//                 <input type="text" ref={Text} placeholder="输入注记内容" className="w-full h-full m-auto rounded-2xl pl-2 border-2 border-selectedColor-300 focus:outline-none focus:ring focus:border-selectedColor-300" />
//             </label>
//             <button className="ControlPanel-LabelAndButton col-start-1 col-end-3 rounded-2xl m-2 text-center" ref={addBtn}>放置文本标记</button>
//             <button className="ControlPanel-LabelAndButton col-start-1 col-end-3 rounded-2xl m-2 text-center" onClick={removeAllText}>清除所有文本标注</button>
//         </div>
//     );
// }
//
